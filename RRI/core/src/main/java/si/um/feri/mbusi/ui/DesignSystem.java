...
public class DesignSystem {
    ...
    public static final Color BACKGROUND_DARK = new Color(0.067f, 0.075f, 0.098f, 1f);       
    public static final Color SURFACE_DARK = new Color(0.098f, 0.110f, 0.141f, 1f);          
    public static final Color SURFACE_ELEVATED = new Color(0.129f, 0.145f, 0.184f, 1f);      
    public static final Color SURFACE_GLASS = new Color(0.129f, 0.145f, 0.184f, 0.85f);      

    
    public static final Color ACCENT_PRIMARY = new Color(0.247f, 0.557f, 0.969f, 1f);        
    public static final Color ACCENT_SECONDARY = new Color(0.608f, 0.318f, 0.878f, 1f);      
    public static final Color ACCENT_GRADIENT_START = new Color(0.247f, 0.557f, 0.969f, 1f); 
    public static final Color ACCENT_GRADIENT_END = new Color(0.400f, 0.851f, 0.937f, 1f);   

    
    public static final Color SUCCESS = new Color(0.180f, 0.800f, 0.443f, 1f);               
    public static final Color WARNING = new Color(0.945f, 0.769f, 0.059f, 1f);               
    public static final Color ERROR = new Color(0.906f, 0.298f, 0.235f, 1f);                 
    public static final Color INFO = new Color(0.204f, 0.596f, 0.859f, 1f);                  

    
    public static final Color TEXT_PRIMARY = new Color(0.961f, 0.965f, 0.980f, 1f);          
    public static final Color TEXT_SECONDARY = new Color(0.651f, 0.682f, 0.749f, 1f);        
    public static final Color TEXT_MUTED = new Color(0.431f, 0.467f, 0.533f, 1f);            
    public static final Color TEXT_INVERSE = new Color(0.067f, 0.075f, 0.098f, 1f);          

    
    public static final Color BORDER = new Color(0.200f, 0.220f, 0.271f, 1f);                
    ...
    public static final Color[] LINE_COLORS = {
        new Color(0.247f, 0.557f, 0.969f, 1f),   
        new Color(0.906f, 0.298f, 0.235f, 1f),   
        new Color(0.180f, 0.800f, 0.443f, 1f),   
        new Color(0.945f, 0.608f, 0.059f, 1f),   
        new Color(0.608f, 0.318f, 0.878f, 1f),   
        new Color(0.000f, 0.737f, 0.831f, 1f),   
        new Color(0.914f, 0.282f, 0.494f, 1f),   
        new Color(0.537f, 0.753f, 0.286f, 1f),   
        new Color(0.969f, 0.788f, 0.247f, 1f),   
        new Color(0.380f, 0.380f, 0.914f, 1f),   
        new Color(0.000f, 0.651f, 0.569f, 1f),   
        new Color(0.878f, 0.412f, 0.122f, 1f),   
        new Color(0.745f, 0.224f, 0.533f, 1f),   
        new Color(0.400f, 0.851f, 0.937f, 1f),   
        new Color(0.620f, 0.565f, 0.435f, 1f),   
    };
    ...
    public static final Color MAP_BACKGROUND = new Color(0.118f, 0.133f, 0.165f, 1f);        
