...
const Features = () => {
  ...
  return (
    <section id="features" className={`py-24 ${isDarkMode ? 'bg-slate-900' : 'bg-white'}`}>
            ...
            return (
              <div
                ...
                className={`group p-6 rounded-2xl border transition-all duration-300 ${
                  isDarkMode
                    ? 'bg-slate-800/50 border-slate-700 hover:bg-slate-800 hover:border-slate-600 hover:shadow-lg hover:shadow-slate-900/50'
                    : 'bg-slate-50 border-transparent hover:bg-white hover:border-slate-200 hover:shadow-xl'
                }`}
              >
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 transition-colors duration-300 ${
                  isDarkMode
                    ? 'bg-marprom-600/10 group-hover:bg-marprom-600'
                    : 'bg-marprom-100 group-hover:bg-marprom-600'
                }`}>
                  <Icon className={`h-6 w-6 transition-colors duration-300 ${
                    isDarkMode
                      ? 'text-marprom-500 group-hover:text-white'
                      : 'text-marprom-600 group-hover:text-white'
                  }`} />
                </div>
