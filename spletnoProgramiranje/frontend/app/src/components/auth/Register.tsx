...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('http://localhost:3000/v1/authentication/register', {
        method: 'POST',
        headers: {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-3xl font-bold text-gray-900">
          Create your M-busi account
        </h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          Already have an account?{' '}
          <a href="/login" className="font-medium text-mbusi-red-600 hover:text-mbusi-red-500">
            Sign in here
          </a>
        </p>
      </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="terms" className="ml-2 block text-sm text-gray-900">
                I agree to the{' '}
                <a href="#" className="text-mbusi-red-600 hover:text-mbusi-red-500">
                  Terms of Service
                </a>{' '}
                and{' '}
                <a href="#" className="text-mbusi-red-600 hover:text-mbusi-red-500">
